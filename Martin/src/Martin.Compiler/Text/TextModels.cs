...
public sealed class TextLine
{
    ...
    public SourceText Text{get;} public int Start{get;} public int Length{get;} public int LengthIncludingLineBreak{get;}
...
public sealed class SourceText
{
    ...
    public char this[int index]=>_text[index]; public int Length=>_text.Length; public string? FilePath{get;} public IReadOnlyList<TextLine> Lines{get;}
    ...
    public LinePosition GetLinePosition(int position){var clamped=Math.Clamp(position,0,Length);var line=GetLineIndex(clamped);return new(line+1,Math.Max(0,clamped-Lines[line].Start));} public LinePositionSpan GetLinePositionSpan(TextSpan span)=>new(GetLinePosition(span.Start),GetLinePosition(span.End));
