...
public sealed class ConstructedTypeKey : IEquatable<ConstructedTypeKey>
{
    ...
    public ConstructedTypeKey(SymbolIdentity definition, ImmutableArray<TypeIdentity> arguments)
    {
        GenericDefinition = definition;
        TypeArguments = arguments.IsDefault ? [] : arguments;
    }
    ...
    public override int GetHashCode()
    {
        ...
        {
            var hash = 17;
            hash = hash * 31 + GenericDefinition.GetHashCode();
