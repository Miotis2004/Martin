...
public sealed class WildcardPatternSyntax : PatternSyntax
{
    public WildcardPatternSyntax(SyntaxToken underscoreToken)
    {
        ...
        AttachPatternChildren(underscoreToken);
    }
...
{
    public IdentifierPatternSyntax(SyntaxToken identifier)
    {
        Identifier = identifier;
        AttachPatternChildren(identifier);
    }
...
public sealed class LiteralPatternSyntax : PatternSyntax
{
    public LiteralPatternSyntax(SyntaxToken literalToken)
    {
        ...
        AttachPatternChildren(literalToken);
    }
...
public sealed class EnumCasePatternSyntax : PatternSyntax
{
    public EnumCasePatternSyntax(SyntaxToken? qualifier, SyntaxToken? dotToken, SyntaxToken caseName, PatternArgumentListSyntax? arguments)
    {
        ...
        CaseName = caseName;
        Arguments = arguments;
        AttachPatternChildren(GetChildren().ToArray());
    }
...
public sealed class OptionalSomePatternSyntax : PatternSyntax
{
    public OptionalSomePatternSyntax(SyntaxToken dotToken, SyntaxToken someIdentifier, SyntaxToken openParenToken, PatternSyntax valuePattern, SyntaxToken closeParenToken)
    {
        ...
        CloseParenToken = closeParenToken;
        AttachPatternChildren(dotToken, someIdentifier, openParenToken, valuePattern, closeParenToken);
    }
    public SyntaxToken DotToken { get; }
...
{
    public ValueBindingPatternSyntax(SyntaxToken letKeyword, SyntaxToken identifier)
    {
        LetKeyword = letKeyword;
        Identifier = identifier;
        AttachPatternChildren(letKeyword, identifier);
    }
