...
{
    public GenericSyntaxNode(SyntaxKind kind, params SyntaxNode[] children)
    {
        Kind = kind;
        Children = children;
...
{
    public GenericStatementSyntax(SyntaxKind kind, params SyntaxNode[] children)
    {
        Kind = kind;
        Children = children;
        AttachChildren(children);
...
{
    public GenericExpressionSyntax(SyntaxKind kind, params SyntaxNode[] children)
    {
        Kind = kind;
        Children = children;
        AttachChildren(children);
